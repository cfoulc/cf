...
//		if (inputs[SOLOED_INPUT].value!=act) 
//			{act = inputs[SOLOED_INPUT].value;
//			if (act>0) solo=5; else solo=0;}
...
//	if ((solo>0)and(solo<5)) {outputs[SOLOED_OUTPUT].value = 10.0;} else outputs[SOLOED_OUTPUT].value = 0.0;
